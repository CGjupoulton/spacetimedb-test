...
export namespace Steve {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: Steve): void {
    Steve.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): Steve {
    return Steve.getTypeScriptAlgebraicType().deserialize(reader);
  }
